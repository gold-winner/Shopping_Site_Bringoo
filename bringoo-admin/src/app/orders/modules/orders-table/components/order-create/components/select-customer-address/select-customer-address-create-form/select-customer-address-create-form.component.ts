...
import { AddressTypeEnum, CountryEntity, CustomerAddressCreateInput } from '../../../../../../../../../shared/api/auth/data-contracts';
...
@Component({
  selector: 'app-select-customer-address-create-form',
  templateUrl: './select-customer-address-create-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SelectCustomerAddressCreateFormComponent extends DynamicForm<CustomerAddressCreateInput> {
