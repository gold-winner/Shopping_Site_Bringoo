...
@UntilDestroy()
@Component({
  selector: 'app-product-management-setup-filter-form',
  templateUrl: './loyalty-program-setup-filter-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class LoyaltyProgramSetupFilterFormComponent extends DynamicFilterFormComponent {
  form = new FormGroup({
