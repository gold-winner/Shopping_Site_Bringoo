...
@UntilDestroy()
@Component({
  selector: 'app-deposit-type-setup-filter-form',
  templateUrl: './deposit-type-setup-filter-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DepositTypeSetupFilterFormComponent extends DynamicFilterFormComponent {
  form = new FormGroup({
