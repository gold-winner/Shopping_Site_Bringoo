...
@UntilDestroy()
@Component({
  selector: 'app-vat-setup-filter-form',
  templateUrl: './vat-setup-filter-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class VatSetupFilterFormComponent extends DynamicFilterFormComponent {
  form = new FormGroup({
