...
@UntilDestroy()
@Component({
  selector: 'app-staff-job-cancel-reason-filter-form',
  templateUrl: './staff-job-cancel-reason-filter-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StaffJobCancelReasonFilterFormComponent extends DynamicFilterFormComponent {
  form = new FormGroup({
