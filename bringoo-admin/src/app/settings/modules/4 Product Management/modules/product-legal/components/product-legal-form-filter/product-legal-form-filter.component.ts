...
@UntilDestroy()
@Component({
  selector: 'app-product-legal-form-filter',
  templateUrl: 'product-legal-form-filter.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ProductLegalFormFilterComponent extends DynamicFilterFormComponent {
  ...
  mapSearch({ search, isActive }: typeof this.form.value): FindInput {
    ...
    return { s: JSON.stringify(s), sort: ['startDateTime,DESC'] };
  }
}
