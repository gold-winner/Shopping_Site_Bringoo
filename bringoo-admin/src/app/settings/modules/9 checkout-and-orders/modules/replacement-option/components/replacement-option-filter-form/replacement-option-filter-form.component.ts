...
@UntilDestroy()
@Component({
  selector: 'app-replacement-option-filter-form',
  templateUrl: './replacement-option-filter-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ReplacementOptionFilterFormComponent extends DynamicFilterFormComponent {
  form = new FormGroup({
