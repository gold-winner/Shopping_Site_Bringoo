...
@UntilDestroy()
@Component({
  selector: 'app-cancel-reason-filter-form',
  templateUrl: './cancel-reason-filter-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CancelReasonFilterFormComponent extends DynamicFilterFormComponent {
  form = new FormGroup({
