...
@UntilDestroy()
@Component({
  selector: 'app-product-promotion-create-form',
  templateUrl: './product-promotion-create-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ProductPromotionCreateFormComponent extends DynamicForm<StoreProductRecommendationCreateInput> implements OnInit {
  form!: FormGroup;
