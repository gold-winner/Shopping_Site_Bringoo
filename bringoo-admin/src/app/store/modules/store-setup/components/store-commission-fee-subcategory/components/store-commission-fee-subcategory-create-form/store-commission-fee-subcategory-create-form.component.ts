...
@Component({
  selector: 'app-store-commission-fee-subcategory-create-form',
  templateUrl: './store-commission-fee-subcategory-create-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StoreCommissionFeeSubcategoryCreateFormComponent extends DynamicForm<CommissionFeeStoreCreateInput> {
