...
@UntilDestroy()
@Component({
  selector: 'app-product-recommendation-filter-form',
  templateUrl: './product-recommendation-filter-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ProductRecommendationFormComponent extends DynamicFilterFormComponent {
  ...
  form = new FormGroup({
    ...
    storeId: new FormControl(this.route?.parent?.parent?.snapshot.params['id']) as FormControl<string>,
  });
