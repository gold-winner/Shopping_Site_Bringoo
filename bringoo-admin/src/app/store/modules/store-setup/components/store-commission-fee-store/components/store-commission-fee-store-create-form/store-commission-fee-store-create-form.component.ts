...
@Component({
  selector: 'app-store-commission-fee-store-create-form',
  templateUrl: './store-commission-fee-store-create-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StoreCommissionFeeStoreCreateFormComponent extends DynamicForm<CommissionFeeStoreCreateInput> {
