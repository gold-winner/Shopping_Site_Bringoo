...
@Component({
  selector: 'app-store-commission-fee-store-update-form',
  templateUrl: './store-commission-fee-store-update-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StoreCommissionFeeStoreUpdateFormComponent extends DynamicForm<CommissionFeeStoreUpdateInput> {
