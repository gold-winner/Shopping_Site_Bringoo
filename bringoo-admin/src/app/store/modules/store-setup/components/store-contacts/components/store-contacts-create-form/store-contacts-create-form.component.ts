...
import { CountryEntity, StoreContactCreateInput, StoreContactTypeEnum } from '../../../../../../../../shared/api/auth/data-contracts';
...
@Component({
  ...
  templateUrl: './store-contacts-create-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StoreContactsCreateFormComponent extends DynamicForm<StoreContactCreateInput> {
  ...
  defaultFormValue: Partial<StoreContactCreateInput> = {
    ...
    contactType: StoreContactTypeEnum.OTHER,
    countryCode: 'DE',
    city: 'Hamburg',
  };
