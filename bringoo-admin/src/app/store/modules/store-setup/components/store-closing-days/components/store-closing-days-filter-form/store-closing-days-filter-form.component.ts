...
@UntilDestroy()
@Component({
  selector: 'app-store-closing-days-filter-form',
  templateUrl: './store-closing-days-filter-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class StoreClosingDaysFilterFormComponent extends DynamicFilterFormComponent {
  form = new FormGroup({
